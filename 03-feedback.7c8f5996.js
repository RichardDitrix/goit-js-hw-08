...
f=setTimeout(x,t),T(l))}return void 0===f&&(f=setTimeout(x,t)),u}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(d="maxWait"in n)?v(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),j.cancel=function(){void 0!==f&&clearTimeout(f),c=0,i=l=o=f=void 0},j.flush=function(){return void 0===f?u:O(g())},j}(e,t,{leading:i,maxWait:t,trailing:o})}});var i=r("dCfNN");let o="feedback-form-state",a={},u=document.querySelector(".feedback-form");u.addEventListener("submit",function(e){e.preventDefault();let{elements:{email:t,message:n}}=e.currentTarget;if(""===t.value||""===n.value)return alert("Form should`nt be empty");let r=new FormData(e.currentTarget);r.forEach((e,t)=>{a[t]=e}),console.log(a),e.currentTarget.reset(),localStorage.removeItem(o)}),u.addEventListener("input",(i&&i.__esModule?i.default:i)(function(e){a.email=u.elements.email.value,a.message=u.elements.message.value,localStorage.setItem(o,JSON.stringify(a))},500)),function(){let e=localStorage.getItem(o);if(e){let{email:t,message:n}=JSON.parse(e);u.email.value=t,u.message.value=n,a.email=t,a.message=n}}()}();//# sourceMappingURL=03-feedback.7c8f5996.js.map

//# sourceMappingURL=03-feedback.7c8f5996.js.map
